...
public interface InterProduct extends java.io.Serializable/* , java.util.Comparator */ {
    ...
    * 이 때는 여러 인터페이스를 다중 상속 받을 수 있음
    * */

    /*
    * 인터페이스는 상수 필드만 작성 가능함
    * public static final 제어자 조합을 상수 필드라고 부름
    * 반드시 선언과 동시에 초기화 해줘야 함
    * */
    public static final int MAX_NUM = 100;

    /* 상수 필드만을 가질 수 있기 때문에 모든 필드는 묵시적으로 public static final */
    int MIN_NUM = 10;
...
//    public void nonStaticMethod(){}       //에러 발생
    ...
    * 반드시 접근제한자를 public으로 해줘야 오버라이딩이 가능함
    * */
    void abstMethod();

    /* 하지만 static 메소드는 작성이 가능함(JDK 1.8 추가된 기능) */
    public static void staticMethod(){

        System.out.println("InterProduct 클래스의 staticMethod 호출됨...");
    }

    /* 또한 default 키워드를 사용하면 non-static 메소드도 작성 가능함(JDK 1.8 추가된 기능) */
