...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 하지만 RuntimeException의 후손 대부분은 예외처리를 강제화하지 않는다.
        * 간단한 조건문 등으로 처리가 가능하기 때문에 따로 강제화하지 않았다.
        * */
        ...
        * */
        ...
        /* 정상적인 프로그램의 흐름을 만들기 위해서는 try-catch 블럭을 작성하는 것이 좋다. */
        try {
            /* 상품 가격보다 가진 돈이 적은 경우 */
...
//            et.checkEnoughMoney(50000, -60000);
            ...
            * 위에 코드를 주석처리 하지 않으면 이 코드는 동작하지 않는다. catch 블럭으로 가는 것이다.
            * */
