...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 요소를 제거할 때는 remove() 메서드를 이용하여 인덱스를 활용한다. */
        linkedList.remove(1);
        ...
        /* set() 메서드를 이용해서 요소를 수정할 수도 있다. */
        linkedList.set(0, "pineapple");

        /* toString() 메서드가 오버라이딩되어 있어서 모든 요소 정보를 쉽게 볼 수 있다. */
        System.out.println(linkedList);

        /* isEmpty() 메서드를 이용해서 list가 비어있는지를 확인할 수 있다. */
        System.out.println(linkedList.isEmpty());

        /* 리스트 내 요소를 모두 제거하는 clear() 메서드를 이용할 수도 있다. */
        linkedList.clear();
