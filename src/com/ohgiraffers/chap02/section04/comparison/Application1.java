package com.ohgiraffers.chap02.section04.comparison;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 비교연산자
        * 비교연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참 혹은 거짓을 반환하는 연산자
        * 연산자 중 참 혹은 거짓을 반환하는 연산자는 삼항연산자의 조건식이나 조건문의 조건절에 많이 사용됨 (충분한 연습 필요)
        *
        * 비교연산자의 종류
        ...
        * */
        ...
        //System.out.println("bool1과 bool2보다 큰지 비교 : " + (bool1 > bool2));
        //System.out.println("bool1과 bool2보다 크거나 같은지 비교 : " + (bool1 >= bool2));
        //System.out.println("bool1과 bool2보다 작은지 비교 : " + (bool1 < bool2));
        //System.out.println("bool1과 bool2보다 작거나 같은지 비교 : " + (bool1 <= bool2));

        /* 4. 문자열값 비교 */
        /* 문자열도 ==과 !=은 비교 가능하지만 대소 비교는 불가능함 */
        String str1 = "java";
        String str2 = "java";
        ...
        //System.out.println("str1과 str2보다 큰지 비교 : " + (str1 > str2));
        //System.out.println("str1과 str2보다 크거나 같은지 비교 : " + (str1 >= str2));
        //System.out.println("str1과 str2보다 작은지 비교 : " + (str1 < str2));
        //System.out.println("str1과 str2보다 작거나 같은지 비교 : " + (str1 <= str2));
