...
public class Application3 {
    public static void main(String[] args){
        ...
        * 따라서 연산 횟수를 줄기이 위해 && 연산의 경우 앞에 false가 나올 가능성이 높은 조건을 작성하는 편이 좋음
        * */
        int num1 = 10;

        /*
        * 앞의 조건을 false로 강제화 해두고 && 뒤의 조건은 선치 증가로 값을 증가시킨 후 별 의미 없는 조건식으로 만들어놨음
        * num1 선치 증가 코드가 동작했다면 result1은 11일 것이고, 동작하지 않았다면 결과는 10일 것
        * */
         ...
         * 뒤의 조건을 확인할 필요없이 true를 반환
         * 따라서 연산 횟수를 줄기이 위해 || 연산의 경우 앞에 true가 나올 가능성이 높은 조건을 작성하는 편이 좋음
         * */
        int num2 = 10;
