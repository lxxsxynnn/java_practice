...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. 2차원 정변 배열을 선언 및 할당하여 사용할 수 있다. */
        /* 1. 배열의 선언 및 할당 */
        /*
        * 정변 배열의 경우 각 인덱스별 배열을 따로 할당할 수도 있지만 선언과 동시에 모든 배열을 할당할 수 있음
        * 자료형[][] 변수명 = new 자료형[할당할 배열의 갯수][할당할 배열의 길이];
        * */
        int[][] iarr = new int[3][5];       //길이 5의 배열을 3개 할당하고 그 주소를 묶어 관리하는 배열의 주소를 stack의 iarr에 저장함
        ...
        /*
        * 그냥 변수 15개를 사용하는 것과 같다고 생각하면 됨
        * 하지만 배열은 []기호 안에 있는 숫자 대신 변수를 사용할 수 있음
        * 따라서 반복문 사용이 가능해짐
        ...
        * */
        ...
        /*
        * 배열 인덱스를 하나씩 증가시키며 0번째 인덱스부터 마지막번째 인덱스까지 차례로 인덱스를 증가시키며 공간에 접근함
        * 접근한 뒤 1부터 1씩 증가하는 값을 이용해서 차례로 값을 대입하고,
        * 모든 인덱스에 값을 다 대입하면 다음 배열의 0번 인덱스부터 다시 접근을 시작하여
        * 배열의 갯수만큼 반복적으로 접하며 값을 대입함
        * */
        ...
        * 매 배열의 값을 다 출력할 때마다 한 줄씩 라인을 바꿔주는 행위를 배열의 갯수만큼 반복하고 있음
        * */
