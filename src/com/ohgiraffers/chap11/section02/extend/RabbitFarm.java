...
public class RabbitFarm<T extends Rabbit> {
    ...
    * 여러 개를 이어서 작성할 떄는 계속 &를 쓰면 되지만 해당 타입을 모두 가지는 타입만 사용 가능함
    * 클래스는 여러 개는 & 사용 불가하며, ,(콤마) 사용 시 컴파일 에러는 발생하지 않지만
    * 뒤에 작성한 클래스를 또 다른 타입변수로 본다.
    ...
    * */
    ...
    /*
    * 해당 클래스는 타입변수를 작성하여 제너릭 클래스를 만들 것이다.
    * 하지만 제너릭스를 설정할 때 extends Rabbit이라고 추가를 해보자
    * */

    /* 타입변수는 아직 어떤 토끼가 될 지 모른다. 다만 토끼이거나 토끼의 후손만 가능하다. */
    private T animal;
