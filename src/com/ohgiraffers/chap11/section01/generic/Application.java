package com.ohgiraffers.chap11.section01.generic;

public class Application {
    public static void main(String[] args) {

        /* 수업목표. 제너릭(generic)에 대해 이해할 수 있다. */
        /*
        * 제너릭(generic)
        * 제너릭의 사전적인 의미는 일반적인이라는 의미이다.
        * 자바에서 제너릭이란 데이터의 타입을 일반화한다는 의미를 가진다.
        *
        * 제너릭은 클래스나 메서드에서 사용할 내부 데이터 타입을 컴파일 시에 지정하는 방법을 말한다.
        * 컴파일 시에 미리 타입 검사를 시행하게 되면 클래스나 메서드 내부에서 사용되는 객체의 타입 안정성을 높일 수 있으며,
        ...
        * */
        ...
        /* 제너릭 클래스로 인스턴스를 생성할 시 타입변수 자리에 사용하려는 타입을 명시해야 한다. */

        /* 타입을 Integer로 인스턴스를 생성하는 경우 */
        GenericTest<Integer> gt1 = new GenericTest<Integer>();

        /* 메서드 인자 및 반환값 모두 Integer 타입인 것을 알 수 있다. */
        ...
        /* 메서드 인자 및 반환값 모두 String 타입인 것을 알 수 있다. */
        gt2.setValue("홍길동");
        ...
        * */
        ...
        /*
        * 사용된 제너릭은 컴파일 시점 타입 변환이 된 후에 사라지게 된다.
        * 컴파일이 완료된 코드에는 제너릭 코드가 제거되어 있는데,
        * 제너릭 이전에 작성된 코드와의 하위 호환성을 위해서이다.
        * */
    }
}
