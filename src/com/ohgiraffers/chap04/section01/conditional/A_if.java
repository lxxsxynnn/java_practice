...
public class A_if {
    ...
    public void testSimpleIfStatement(){
        ...
        * */
        ...
        /*
        * 조건식 : true of false가 나오는 연산식을 조건식이라고 함
        * if문은 조건식의 결과값이 참(true)이면 { } 안에 있는 코드를 실행하고,
        * 조건식의 결과값이 거짓(false)이면 { } 안에 있는 코드를 무시하고 넘어감
        * */

        /* 조건을 만족하는 경우에만 추가적인 명령을 실행시키고자 할 때 주로 사용 */
        ...
        * */
        if(num % 2 == 0){
            ...
            * 하지만 false인 경우 if블럭 전체를 무시하고 건너뛰며 실행하게 됨
            * */
