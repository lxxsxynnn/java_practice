...
public class D_switch {
    ...
    public void testSimpleSwitchStatement(){
        ...
        * 실수와 논리는 비교 불가
        * 또한 정확하게 일치하는 경우만 비교할 수 있으며 대소비교를 할 수 없다는 차이가 있음
        * case절에는 변수를 사용하지 못함(값만 비교 가능)
        * 또한, 문자열 비교는 jdk 1.7 이상부터 가능함
        * */
    ...
    public void testSwitchVendingMachine(){
        ...
        * 2. break를 사용하지 않으면 멈추지 않고 계솔 실행구문을 동작시킨다.
        * */
        ...
        /*
        * 선택한 메뉴에 따라 구문이 출력은 됨(문자열 비교 가능)
        * 하지만 한 개의 메뉴를 선택해도 그 메뉴 이후의 메뉴가 전부 선택이 되는 이상한 자판기가 되었음
        * 가격 또한 음료 별로 다르지만 마지막 메뉴 가격이 1000원으로 고정되어 있음
        * */
