...
public class A_for {
    ...
    public void testSimpleForStatement(){
        ...
        /* 수업목표. for문 단독 사용에 대한 프름을 이해하고 적용할 수 있다. */
        /*
        * [for문 표현식]
        * for(초기식; 조건식; 증감식){
        ...
        * */
        ...
        /*
        * 반복문의 문법보다 어려운 것은 언제 반복문을 사용하는지 판단하는 것
        * 때문에 반복문을 사용하는 간략한 예제들을 하나씩 살펴볼 예정
        * */
    }
    ...
    public void testForExample1(){
        ...
        System.out.println("10명의 학생 이름을 입력받고 출력하는 기능을 완성했습니다.");
    ...
    public void testForExample2(){
        ...
        * */
        ...
        /*
        * 이렇게만 작성되어 있으면 처음 프로그래밍을 하는 사람에게는 꽤나 난감하다.
    ...
    public void testForExample4(){
        ...
        * */
        ...
        if(first > second){
            ...
            /* 둘 중 더 작은 second가 시작하는 값이 되고 더 큰 first가 끝나는 값이 됨 */
            for(int i = second; i <= first; i++){
                sum += i;
            }
        /* 반대로 두 번째 정수가 더 큰 경우 */
        } else {
            /* 둘 중 더 작은 first가 시작하는 값이 되고 더 큰 second가 끝나는 값이 됨 */
        ...
        * 작은 수 ~ 큰 수까지의 합계를 구하는 로직으로 바꿀 수 있음
        * */

        /* 더 큰 값과 작은 값을 저장할 변수를 초기화 */
        int min = 0;
        int max = 0;

        if(first > second){

            /* 처음 입력한 숫자가 더 크면 first가 max이고, 자동으로 second는 min이 됨 */
            max = first;
            min = second;
        /* 반대 조건인 경우 */
        } else {

            /* 처음 입력한 숫자가 더 작으면 first는 min이고, 자동으로 second는 max가 됨 */
            max = second;
            min = first;
        }

        /* 반복문의 시작값은 min, 종료값은 max로 해 두면 됨 */
        int sum2 = 0;
