...
public class B_continue {
    ...
    public void testSimpleContinueStatement2(){
        ...
        /* 수업목표. 중첩반복문 내 continue문 사용에 대한 흐름을 이해하고 적용할 수 있다. */
        /* continue는 모든 반복문을 건너뛰는 것이 아닌 자신에게 가장 인접한 반복문 실행만 건너뜀 */
        ...
        for(int dan = 2; dan < 10; dan++){
            ...
            for(int su = 1; su < 10; su++){
                if(dan % 2 == 0){
                    ...
                    /* su가 짝수인 경우 해당 회차 반복 내용을 건너뛰고 증감식으로 이동 */
                    continue;
                }
    ...
    public void testJumpContinue(){
        ...
        /* 수업목표. 중첩반복문 내 continue문 사용 시 jump(goto)에 대한 흐름을 이해하고 적용할 수 있다. */
        label:
        for(int dan = 2; dan < 10; dan++){
            ...
            for(int su = 1; su < 10; su++){
                if(su % 2 == 0){
                    ...
                    /* su가 짝수인 경우 해당 회차 반복 내용을 건너뛰고 이름이 부여된 증감식으로 이동 */
                    continue label;
                }
                System.out.println("dan = " + dan + " * " + su + " = " + (dan * su));
            }
            System.out.println();
        }
    }
