...
public class Application8 {
    ...
    public static void main(String[] args) {
        ...
        /* static 메소드 호출 */
        /*
        * 우리가 지금 작성하고 있는 메소드를 보면 public과 void 사이에 static이라고 하는 키워드가 있음
        * static 키워드에 대해서는 뒤에서 다시 다룰 예정이지만
        * static 메소드를 호출하는 방법부터 먼저 학습해보기
        * static이 있는 메소드이건 non-static 메소드이건 메소드의 동작 흐름은 동일 */

        /*
        * static 메소드를 호출하는 방법
        * 클래스명.메소드명(); <- 이런 방식으로 호출
        * */
