package com.ohgiraffers.chap15.section01.intenum;
...
public class Application {
    public static void main(String[] args) {
        ...
        /* 2. 이름 충돌 방지를 위해 접두어를 써서 구문해야 한다. */
        ...
        * */
        ...
        /* 3. 문자열로 출력하기 까다롭다. */
        /*
        * 경우에 따라서는 JAVA, HTML과 같은 상수값을 문자열로 사용해야 하는 경우가 있다.
