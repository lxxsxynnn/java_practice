package com.ohgiraffers.chap15.section02.enumtype;
...
public class Application {
    public static void main(String[] args) {
        ...
        * public enum Frontedn { HTML, CSS, JAVASCRIPT }
        * */
...
//        printSubject(2);        //Enumtype은 인스턴스이기 때문에 정수를 사용하는 경우 타입 불일치(컴파일 에러)
    }
