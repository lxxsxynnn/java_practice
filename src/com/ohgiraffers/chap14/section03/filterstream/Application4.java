...
import com.ohgiraffers.chap14.section03.filterstream.dto.MemberDTO;
...
public class Application4 {
    public static void main(String[] args) {
        ...
        * dto 패키지를 하나 추가한 뒤 MemberDTO를 하나 만들자
        * */
        MemberDTO[] outputMebers = {
        ...
        try {
            objOut = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("src/com/ohgiraffers/chap14/section03/filterstream/testObjectStream.txt")));

            for(int i = 0; i < outputMebers.length; i++){
                objOut.writeObject(outputMebers[i]);
            }
        ...
        * */
        ...
        try {
            ...
            objIn = new ObjectInputStream(new BufferedInputStream(new FileInputStream("src/com/ohgiraffers/chap14/section03/filterstream/testObjectStream.txt")));
        ...
        /* 직렬화 대상에서 제외하고 싶은 필드의 경우 transient 키워드를 이용할 수있다. (DTO 수정 후 확인) */
    }
}
