...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            bw = new BufferedWriter(new FileWriter("src/com/ohgiraffers/chap14/section03/filterStream/testBuffered.txt"));

            bw.write("안녕하세요.\n");
            bw.write("반갑습니다.\n");

            /*
            * 버퍼를 이용하는 경우 버퍼가 기록자면 자동으로 내보내기를 하지만
            * 버퍼가 가득 차지 않는 상태에서는 강제로 내보내기를 해야 한다.
            * close() 전에 확인해보면 파일에 기록되지 않은 것을 볼 수 있다.
        ...
        * */
        ...
        try {
            br = new BufferedReader(new FileReader("src/com/ohgiraffers/chap14/section03/filterStream/testBuffered.txt"));
