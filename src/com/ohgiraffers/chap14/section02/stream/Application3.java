    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            ...
            * false는 이어쓰가기 아닌 덜어쓰기이며 기본값은 false이다 .*/
            fout = new FileOutputStream("src/com/ohgiraffers/chap14/section02/stream/testOutputStream.txt");

            /* writer() 메서드는 IOException을 핸들링해야 한다. */
            fout.write(97);
