    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            ...
            * */
            fr = new FileReader("src/com/ohgiraffers/chap14/section02/stream/testReader.txt");

            /* 여기는 한글로 작성을 해도 읽어올 수 있으니 적당히 txt 파일에 글자를 입력해두자 */
...
//            }
            ...
            * 유니코드로 변환된 한글은 byte에 저장하기에 더 큰 숫자를 가져서 오버플로우가 일어난다.
            ...
            * */
            char[] carr = new char[(int) new File("src/com/ohgiraffers/chap14/section02/stream/testReader.txt").length()];
