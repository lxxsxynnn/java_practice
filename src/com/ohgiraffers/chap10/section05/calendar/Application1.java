...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 생성자를 비롯하여 대부분의 메소드가 Deprecated 되어 있다.(API 문서 참조)
        *
        * Deprecated란?
        * 향후 버전이 업데이트 되면서 사라지게 될 기능이니 가급적이면 사용을 권장하지 않는다는 의미이다.
        * 하지만 하위 버전의 호환성 때문에 한 번에 제거된 것은 아니고 남겨두었기 때문에 사용하는 것은 가능하다.
        * */
        ...
        *    12월 31일의 마지막에 추가하거나, 혹은 6월 20일의 마지막에 추가한다.
        *    윤초는 사소해보이지만 실제로 2012년 링크드인과 같은 대규모 서비스의 서버를 마비시킨 버그를 발생시킨 적도 있다.
        ...
        * */
        ...
        /* toString() 메서드가 오버라이딩 되어 있어서 쉽게 필드값을 출력해볼 수 있다. */
        ...
        * */
        Date time = new Date(1753401799653L);
