package com.ohgiraffers.chap10.section03.stringbuilder;

public class Application2 {
    public static void main(String[] args) {

        /* 수업목표. StringBuilder의 자주 사용되는 메서드의 용법을 이해할 수 있다. */
        /* StringBuilder 기본 생성자로 인스턴스 생성 */
        StringBuilder sb1 = new StringBuilder();

        /* capacity() : 용량(현재 버퍼의 크기)을 정수형으로 반환하는 메서드(문자열 길이 + 16이 기본 용량) */
        System.out.println(sb1.capacity());

        /*
        * append() : 인자로 전달된 값을 문자열로 변환 후 기존 문자열의 마지막에 추가한다.
        * 기본 용량을 초과하는 경우(기존 문자열 + 1) * 2를 하려 용량을 확장시킨다.
        * https://stackoverflow.com/question/3184244/stringbuilder-capacity
        * */
        for (int i = 0; i < 50; i++) {
            sb1.append(i);
