...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *      두 번째 이용 시에는 인스턴스 생성 시간 없이 사용할 수 있음
        *   2. 인스턴스가 절대적으로 한 개만 존재하는 것을 보증할 수 있음
        *   단점
        ...
        * */
        ...
        /* 1. 이른 초기화 구현 */
        /* 생성자를 이용하여 인스턴스 생성을 하지 못하고 getInstance() 메소드를 호출해야만 인스턴스를 생성할 수 있음 */
        //EagerSingleton eager = new EagerSingleton();      //생성자가 private이라 접근 불가
        EagerSingleton eager1 = EagerSingleton.getInstance();
        EagerSingleton eager2 = EagerSingleton.getInstance();

        /* 두 인스턴스의 hashcode가 동일한 것을 알 수 있음(동일한 인스턴스) */
        ...
        * 첫 번째 요청에 대한 속도가 두 번째 요청에 대한 속도보다 느리다는 특징을 가지고 있음
        * */

        /*
        * 동시성을 고려한 다양한 싱글톤 구현 방식은 많지만
        * 난이도가 매우 높으므로 여기까지만 다루고 싱글톤이라는 개념을 이해하도록 함
        * */
    }
}
