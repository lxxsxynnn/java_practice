...
public class Application3 {
    public static void main(String[] args) {
        ...
        /* 수업목표. 스트림의 최종연산 중 하나인 collect에 대해 이해하고 사용할 수 있다. */
        /*
        * collect()는 Collector 타입을 받아서 처리하는데, 해당 메서드를 통해 컬렉션을 출력으로 받을 수 있다.
        * collect() 메서드는 Collector 객체에서 제공하는 정적 메서드를 사용할 수 있다.
        * */
