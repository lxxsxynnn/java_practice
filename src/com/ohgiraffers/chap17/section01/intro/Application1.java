...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 스트림(Stream)은 자바 8부터 추가된 기능으로 컬렉션에 저장된 엘리먼트들을 하나씩 순회하면서 처리할 수 있는 기능이다.
        * 자바 8 이전에 배열 또는 컬렉션을 다루는 방법은 `for`, `foreach`를 사용하여 엘리먼트들을 꺼내서 다루는 방법이었다.
        ...
        * 스트림은 내부 반복자를 사용하기 때문에 병렬 처리가 쉽다는 장점이 있다.
        * */
