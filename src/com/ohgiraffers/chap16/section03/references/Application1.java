...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 수업목표. 메서드 참조에 대해 이해하고 사용할 수 있다. */
        /*
        * 메서드 참조(method references)는 함수형 인터페이스를 람다식이 아닌 일반 메서드를 참조시켜 선언하는 방법이다.
        * 일반 메서드를 참조하기 위해서는 함수형 인터페이스의 매개변수 타입/갯수/반환형과 메서드의 매개변수 타입/갯수/반환형이 같아야 한다.
        * [메서드 참조 표현식]
        * 클래스이름::메서드이름
        * 참조변수이름::메서드이름
        * */
