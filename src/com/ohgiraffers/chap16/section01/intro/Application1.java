...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 람다(lambda)식
        * JDK 1.8에서 추가된 기능으로 메서드를 하나의 식(expression)으로 표현한 것이다.
        * 메서드를 람다식으로 표현하면 메서드 이름이 없는 익명함수라고 할 수 있다.
        * 람다식은 알론조 처치라는 수학자가 1936년에 발표한 람다 계산법에 기초하고 있다.
        * f(x, y) = x * y
        ...
        * */
        ...
        /*
        * 인터페이스에 정의된 추상메서드를 활용하기 위해서는 3가지 방법이 있다.
        * 1. 인터페이스를 상속받은 클래스를 정의하여 기능을 완성 후 사용하는 방법
        * 2. 익명클래스를 활용하여 메서드 재정의 후 사용하는 방법
        * 3. 람다식을 활용하는 방법
        * */

        /* 1. 인터페이스를 구현한 구현체를 이용한 방식 */
        ...
        System.out.println("20과 30의 합은 : " + c2.sumToNumber(30, 30));

        /* 3. 람다식을 활용한 방식*/
        Calculator c3 = (x, y) -> x + y;
        System.out.println("40과 50의 합은 : " + c3.sumToNumber(40, 50));
    }
}
